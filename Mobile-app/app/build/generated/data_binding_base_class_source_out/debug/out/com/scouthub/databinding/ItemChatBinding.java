...
public final class ItemChatBinding implements ViewBinding {
  ...
  private ItemChatBinding(@NonNull CardView rootView, @NonNull TextView lastMessage,
      @NonNull TextView name, @NonNull ImageView profileImage, @NonNull TextView time) {
  ...
  public static ItemChatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChatBinding((CardView) rootView, lastMessage, name, profileImage, time);
    }
